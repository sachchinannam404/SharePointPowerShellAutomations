...
$Webs = Get-SPWeb http://sitecoll/sites/Admin/
$Result = @()
...
$Result | Select 'Site Title',URL,'Library Type','Library Title',Count,'Last Modified' | Export-Csv "$ReportPath\SGAdmin1.csv" -NoTypeInformation
